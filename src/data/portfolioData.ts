...
export const EXPERIENCE_DATA: ExperienceItem[] = [
  {
    ...
    highlights: [
      ...
      "Worked across requirements, application and database design, development, testing, deployment, and maintenance.",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Participated in debugging, code improvements, feature development, and application testing throughout the development lifecycle.",
    ],
    technologies: [
      "React",
      "Node.js",
