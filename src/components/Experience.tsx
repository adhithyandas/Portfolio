...
export const Experience: React.FC = () => {
  return (
    <section id="experience" className="py-20 bg-[#0B1120] relative border-t border-[#1E293B]/50">
        ...
        <div className="relative pl-6 sm:pl-8 space-y-12 before:content-[''] before:absolute before:left-2 sm:before:left-3 before:top-2 before:bottom-2 before:w-0.5 before:bg-[#1E293B]">
          {EXPERIENCE_DATA.map((exp) => (
            <div key={exp.id} className="relative group">
              ...
              <div className="absolute -left-[23px] sm:-left-[27px] top-1.5 w-4 h-4 rounded-full bg-[#0B1120] border-2 border-[#38BDF8] group-hover:scale-125 group-hover:bg-[#38BDF8] transition-all duration-300 shadow-[0_0_10px_rgba(56,189,248,0.3)]" />
